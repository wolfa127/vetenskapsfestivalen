...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     				=> 'WPBakery Visual Composer 4.3.5 for Impreza theme', // The plugin name
			'slug'     				=> 'impreza_js_composer_435', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory() . '/vendor/plugins/impreza_js_composer_435.zip', // The plugin source
