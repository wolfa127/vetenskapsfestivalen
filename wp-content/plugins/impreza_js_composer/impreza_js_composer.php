...
class Vc_Manager {
	...
	private $plugin_name = 'impreza_js_composer/impreza_js_composer.php';
	/**
	...
	public function isNetworkPlugin() {
		if ( is_null( $this->is_network_plugin ) ) {
			...
			if ( is_multisite() && ( is_plugin_active_for_network( 'impreza_js_composer/impreza_js_composer.php' )
			  || is_network_only_plugin( 'impreza_js_composer/impreza_js_composer.php' ) )
			) {
